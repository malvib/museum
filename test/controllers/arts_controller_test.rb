...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { artist: @art.artist, date: @art.date, description: @art.description, photo: @art.photo, place: @art.place, reference: @art.reference, size: @art.size, technic: @art.technic, title: @art.title } }
    end
